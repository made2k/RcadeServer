	...
	<body>
		...
		<div id="show-score" class="content scaffold-show" role="main">
			...
			<ol class="property-list score">
				...
				<li class="fieldcontain">
					<span id="cabinetID-label" class="property-label"><g:message code="score.cabinetID.label" default="Cabinet ID" /></span>
					
						<span class="property-value" aria-labelledby="cabinetID-label"><g:fieldValue bean="${scoreInstance}" field="cabinetID"/></span>
				...
				<li class="fieldcontain">
					<span id="dateCreated-label" class="property-label"><g:message code="score.dateCreated.label" default="Date" /></span>
				...
				<li class="fieldcontain">
					<span id="arcadeName-label" class="property-label"><g:message code="score.arcadeName.label" default="Arcade Name" /></span>
					
						<span class="property-value" aria-labelledby="arcadeName-label"><g:fieldValue bean="${scoreInstance}" field="arcadeName"/></span>
