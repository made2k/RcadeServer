...
function refresh()
{
	document.getElementById('latest-iframe').src = document.getElementById('latest-iframe').src;
	resize();
}
...
<body>
	...
	<button id="startButton" onclick="startTimer()">Start iframe refresh timer</button>
	<button id="stopButton" onclick="stopTimer()">Stop iframe refresh timer</button>
